...
\end{multicols}
		...
		\begin{itemize}[leftmargin=0.5cm]
			\item \cvcompany{软件开发实习生 @ 亚马逊北京}{2020.07 - 至今}\cvsublevel{%
			\cvsubbullet{%
				负责移动端基础架构部存储相关的功能调研、设计和开发，为亚马逊 MShop 客户端应用提供可靠、快速、高效的存储支持。 %
			}% 
		}
		\item \cvcompany{算法开发实习生 @ 腾讯深圳 AI Lab Robotics X 实验室}{2019.11 - 2020.06}\cvsublevel{%
			\cvsubbullet{%
		...
		% 	}
		% }
		\item \cvcompany{前端开发实习生 @ 百度北京}{2016.12 - 2017.05}\cvsublevel{%
			\cvsubbullet{%
		...
		\begin{adjustwidth}{0.1cm}{0cm}
			...
			\cvcompany{\project{github.com/Yidadaa/Issue-Blog-With-Github-Action}{Vue / Javascript}{$\approx 1000$ lines}}{2020.01}\\
