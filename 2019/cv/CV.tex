...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\cvtitle{Zhang YiFei}{BrickRed}{BSc, MA}{0.5cm}
\positionedbox{left}{0.7\textwidth}{%
	\information{+86 13032883129}{pic}{\Telefon}\\%
	\information{flynn.zhang@foxmail.com}{pic}{\MVAt}\\%
	\information{blog.simplenaive.com}{pic}{\Flatsteel}\\%
	\information{github.com/Yidadaa}{pic}{$\mathcal{T}$}\\%
}
\positionedbox{right}{0.3\textwidth}{DOB: 20/01/97\\Nationality: China}
%
...
\item \cvcompany{Research on Depth Estimation}{2018 - on-going}\cvsublevel{%
