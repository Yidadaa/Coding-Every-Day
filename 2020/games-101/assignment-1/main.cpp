...
Eigen::Matrix4f get_model_matrix(float rotation_angle)
{
    ...
    double m00 = std::cos(rotation_angle * MY_PI / 180.0);
    double m01 = std::sin(-rotation_angle * MY_PI / 180.0);
    double m10 = std::sin(rotation_angle * MY_PI / 180.0);
    double m11 = std::cos(rotation_angle * MY_PI / 180.0);
